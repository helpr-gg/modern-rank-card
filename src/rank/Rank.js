...
module.exports = class RankCard {
	...
	async toAttachment() {
		...
		ctx.quadraticCurveTo(canvas.width - this.sideSpace, canvas.height - this.sideSpace, canvas.width - this.sideSpace - this.radiusCornerLayer, canvas.height - this.sideSpace);
